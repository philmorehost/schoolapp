<?php
	...
	$create_route_list_table = mysqli_query($connection_server, "CREATE TABLE IF NOT EXISTS sm_route_lists (id_number INT(225) NOT NULL AUTO_INCREMENT, school_id_number VARCHAR(225) NOT NULL, numeric_class_name VARCHAR(225) NOT NULL, subject_code VARCHAR(225) NOT NULL, day_code VARCHAR(225) NOT NULL, start_time VARCHAR(225) NOT NULL, end_time VARCHAR(225) NOT NULL, PRIMARY KEY (id_number))");
